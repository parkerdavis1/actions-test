import { A as AstroError, e as createComponent, r as renderTemplate, g as addAttribute, i as renderHead, j as renderSlot, h as createAstro, k as renderComponent, m as maybeRenderHead } from '../astro_B06UDcVc.mjs';
/* empty css                          */
import { AsyncLocalStorage } from 'node:async_hooks';

const ApiContextStorage = new AsyncLocalStorage();
function getApiContext$1() {
...
async function getAction(path) {
  ...
  let { server: actionLookup } = await import('../index_B9GhLcXm.mjs');
...
async function actionHandler(param, path) {
  {
    const { getAction } = await Promise.resolve().then(() => utils);
...
}, "/Users/parkerdavis/projects/actions-test/src/layouts/Layout.astro", void 0);
...
/* src/components/Form.svelte generated by Svelte v4.2.18 */

const Form = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	let message = 'waiting...';
	let submissions = [];

	return `<form method="POST" data-svelte-h="svelte-714chq"><label for="name">Name
        <input type="text" name="name"></label> <label for="email">Email
        <input type="email" name="email" id="email"></label> <button type="submit">Submit</button></form> <p>${escape(message)}</p> <pre>${escape(JSON.stringify(submissions, null, 2))}</pre>`;
});
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Welcome to Astro.", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main data-astro-cid-j7pv25f6> ${renderComponent($$result2, "Form", Form, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/parkerdavis/projects/actions-test/src/components/Form.svelte", "client:component-export": "default", "data-astro-cid-j7pv25f6": true })} </main> ` })} `;
}, "/Users/parkerdavis/projects/actions-test/src/pages/index.astro", void 0);

const $$file = "/Users/parkerdavis/projects/actions-test/src/pages/index.astro";
const $$url = "";
...
export { ApiContextStorage as A, callSafely as c, defineAction as d, formContentTypes as f, getAction as g, hasContentType as h, index as i, objectType as o, stringType as s };
